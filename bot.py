...
*Меню редактирования фото*
    ...
    1. ↩️ Повернуть по часовой — повернуть расклад по часовой стрелке (N → E → S → W → N)
    2. ↪️ Повернуть против часовой — повернуть расклад против часовой (N → W → S → E → N)
    3. ➕ Добавить карту — выбрать потерянную карту и руку, в которую эту карту положить
    4. 🔀 Переместить карту — переложить выбранную карту в выбранную руку
...
*Режим анализа*
    ...
    2.2 📜 История — показать все взятки; *ваши* ходы помечены **^^^** (оптимальные ходы не маркируются); формат карт *N♥A* — туз ♥ с руки N
